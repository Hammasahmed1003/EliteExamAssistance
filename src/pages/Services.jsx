...
const courseServices = [
  {
    ...
    features: ['Course-by-course guidance', 'Weekly study structure', 'Personalized progress support'],
  },
  {
  ...
  },
  {
    ...
    title: 'Sophia',
    description:
      'Clear, step-by-step guidance for Sophia courses so you can complete assignments efficiently and move through credits faster.',
    features: ['Assignment support', 'Pacing help', 'Smarter study strategy'],
  },
  {
    icon: <BrainCircuit size={24} />,
    title: 'Apex Courses',
    description:
      'Targeted coaching for Apex coursework with support that helps students stay organized, understand concepts, and finish strong.',
...
const certificationServices = [
  ...
  },
  {
    ...
    features: ['Science and math review', 'Pacing strategy', 'Targeted practice'],
  },
  {
    icon: <Trophy size={24} />,
    title: 'ATI TEAS',
    ...
    features: ['High-yield study plans', 'Section coaching', 'Performance tracking'],
  },
  {
    icon: <Trophy size={24} />,
    title: 'HESI',
    ...
    features: ['Weak-area targeting', 'Question breakdowns', 'Confidence coaching'],
  },
  {
    icon: <Trophy size={24} />,
    title: 'CNA',
  ...
  },
  {
    ...
    title: 'CompTIA',
    description:
      'Certification prep for CompTIA students who need organized study structure and a clearer path through technical material.',
    features: ['Topic-by-topic coaching', 'Study accountability', 'Exam-focused review'],
  },
];
